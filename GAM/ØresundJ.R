...
mod.codJ <- gam(cpue ~ #
                  ...
                  Quarter + 
                  SedimentDK,
                data = subset(dat_cod, loc == "øresund_codJ"),
                family=tw)
...
mod.flounderJ <- gam(cpue ~ 
                  ...
                  Quarter+
                  SedimentDK,
                data = subset(dat_flounder, loc == "øresund_flounderJ"), 
                family=tw) 
...
mod.plaiceJ <- gam(cpue ~ 
                  ...
                  Quarter+ 
                  SedimentDK,
                data = subset(dat_plaice, loc == "øresund_plaiceJ"), 
                family=tw) 
...
mod.herringJ <- gam(cpue ~ 
             ...
             #    s(Gear,bs="re")+ 
                  Quarter+ 
                  SedimentDK,
                data = subset(dat_herring, loc == "øresund_herringJ"),
                family=tw) 
...
mod.spratJ <- gam(cpue ~ 
                  ...
                  Quarter+ 
                  SedimentDK,
                data = subset(dat_sprat, loc == "øresund_spratJ"), 
                family=tw) 
...
mod.whitingJ <- gam(cpue ~ 
              ...
              #   s(Gear,bs="re")+ 
                  Quarter+ 
                  SedimentDK,
                data = subset(dat_whiting, loc == "øresund_whitingJ"), 
                family=tw) 
...
newdat <- expand.grid(period = levels(dat_cod$period),
                      loc = c("øresund_codJ","øresund_flounderJ",
                              "øresund_plaiceJ","øresund_herringJ",
                              "øresund_spratJ","øresund_whitingJ"),
...
newdat$cpue_pred <- NA
newdat$cpue_pred[newdat$loc == "øresund_codJ"] <- tmp1$fit[newdat$loc == "øresund_codJ"]
newdat$cpue_pred[newdat$loc == "øresund_flounderJ"] <- tmp2$fit[newdat$loc == "øresund_flounderJ"]
newdat$cpue_pred[newdat$loc == "øresund_plaiceJ"] <- tmp3$fit[newdat$loc == "øresund_plaiceJ"]
newdat$cpue_pred[newdat$loc == "øresund_herringJ"] <- tmp4$fit[newdat$loc == "øresund_herringJ"]
newdat$cpue_pred[newdat$loc == "øresund_spratJ"] <- tmp5$fit[newdat$loc == "øresund_spratJ"]
newdat$cpue_pred[newdat$loc == "øresund_whitingJ"] <- tmp6$fit[newdat$loc == "øresund_whitingJ"]

newdat$cpue_sd <- NA
newdat$cpue_sd[newdat$loc == "øresund_codJ"] <- tmp1$se.fit[newdat$loc == "øresund_codJ"]
newdat$cpue_sd[newdat$loc == "øresund_flounderJ"] <- tmp2$se.fit[newdat$loc == "øresund_flounderJ"]
newdat$cpue_sd[newdat$loc == "øresund_plaiceJ"] <- tmp3$se.fit[newdat$loc == "øresund_plaiceJ"]
newdat$cpue_sd[newdat$loc == "øresund_herringJ"] <- tmp4$se.fit[newdat$loc == "øresund_herringJ"]
newdat$cpue_sd[newdat$loc == "øresund_spratJ"] <- tmp5$se.fit[newdat$loc == "øresund_spratJ"]
newdat$cpue_sd[newdat$loc == "øresund_whitingJ"] <- tmp6$se.fit[newdat$loc == "øresund_whitingJ"]
...
newdat$cpue_pred.log[newdat$loc == "øresund_codJ"] <- tmp1.log$fit[newdat$loc == "øresund_codJ"]
newdat$cpue_pred.log[newdat$loc == "øresund_flounderJ"] <- tmp2.log$fit[newdat$loc == "øresund_flounderJ"]
newdat$cpue_pred.log[newdat$loc == "øresund_plaiceJ"] <- tmp3.log$fit[newdat$loc == "øresund_plaiceJ"]
newdat$cpue_pred.log[newdat$loc == "øresund_herringJ"] <- tmp4.log$fit[newdat$loc == "øresund_herringJ"]
newdat$cpue_pred.log[newdat$loc == "øresund_spratJ"] <- tmp5.log$fit[newdat$loc == "øresund_spratJ"]
newdat$cpue_pred.log[newdat$loc == "øresund_whitingJ"] <- tmp6.log$fit[newdat$loc == "øresund_whitingJ"]
newdat$cpue_sd.log <- NA
newdat$cpue_sd.log[newdat$loc == "øresund_codJ"] <- tmp1.log$se.fit[newdat$loc == "øresund_codJ"]
newdat$cpue_sd.log[newdat$loc == "øresund_flounderJ"] <- tmp2.log$se.fit[newdat$loc == "øresund_flounderJ"]
newdat$cpue_sd.log[newdat$loc == "øresund_plaiceJ"] <- tmp3.log$se.fit[newdat$loc == "øresund_plaiceJ"]
newdat$cpue_sd.log[newdat$loc == "øresund_herringJ"] <- tmp4.log$se.fit[newdat$loc == "øresund_herringJ"]
newdat$cpue_sd.log[newdat$loc == "øresund_spratJ"] <- tmp5.log$se.fit[newdat$loc == "øresund_spratJ"]
newdat$cpue_sd.log[newdat$loc == "øresund_whitingJ"] <- tmp6.log$se.fit[newdat$loc == "øresund_whitingJ"]


write_rds (newdat, "newdat/newdat_øresundJ.rds")
