...
mod.codA <- gam(cpue ~ #response
                 period+
                  ...
                  Quarter+ 
                  SedimentDK, 
                data = subset(dat_cod, loc == "femeren_codA"), 
                family=tw) 
...
mod.flounderA <- gam(cpue ~ #response
                  ...
                  Quarter+ 
                  SedimentDK, 
                data = subset(dat_flounder, loc == "femeren_flounderA"), 
                family=tw) 
...
mod.plaiceA <- gam(cpue ~ 
                  ...
                  Quarter+ 
                  SedimentDK, 
                data = subset(dat_plaice, loc == "femeren_plaiceA"), 
                family=tw) 
...
mod.herringA <- gam(cpue ~ #response
                  ...
                  Quarter+ 
                  SedimentDK, 
                data = subset(dat_herring, loc == "femeren_herringA"),
                family=tw) 
...
mod.spratA <- gam(cpue ~ #response
                  ...
                  Quarter+ 
                  SedimentDK, 
                data = subset(dat_sprat, loc == "femeren_spratA"), 
                family=tw) 
...
mod.whitingA <- gam(cpue ~ #response
                  ...
                  Quarter+ 
                  SedimentDK, 
                data = subset(dat_whiting, loc == "femeren_whitingA"), 
                family=tw) 
...
newdat <- expand.grid(period = levels(dat_cod$period),
                      loc = c("femeren_codA","femeren_flounderA",
                              "femeren_plaiceA","femeren_herringA",
                              "femeren_spratA","femeren_whitingA"),
...
newdat$cpue_pred <- NA
newdat$cpue_pred[newdat$loc == "femeren_codA"] <- tmp1$fit[newdat$loc == "femeren_codA"]
newdat$cpue_pred[newdat$loc == "femeren_flounderA"] <- tmp2$fit[newdat$loc == "femeren_flounderA"]
newdat$cpue_pred[newdat$loc == "femeren_plaiceA"] <- tmp3$fit[newdat$loc == "femeren_plaiceA"]
newdat$cpue_pred[newdat$loc == "femeren_herringA"] <- tmp4$fit[newdat$loc == "femeren_herringA"]
newdat$cpue_pred[newdat$loc == "femeren_spratA"] <- tmp5$fit[newdat$loc == "femeren_spratA"]
newdat$cpue_pred[newdat$loc == "femeren_whitingA"] <- tmp6$fit[newdat$loc == "femeren_whitingA"]

newdat$cpue_sd <- NA
newdat$cpue_sd[newdat$loc == "femeren_codA"] <- tmp1$se.fit[newdat$loc == "femeren_codA"]
newdat$cpue_sd[newdat$loc == "femeren_flounderA"] <- tmp2$se.fit[newdat$loc == "femeren_flounderA"]
newdat$cpue_sd[newdat$loc == "femeren_plaiceA"] <- tmp3$se.fit[newdat$loc == "femeren_plaiceA"]
newdat$cpue_sd[newdat$loc == "femeren_herringA"] <- tmp4$se.fit[newdat$loc == "femeren_herringA"]
newdat$cpue_sd[newdat$loc == "femeren_spratA"] <- tmp5$se.fit[newdat$loc == "femeren_spratA"]
newdat$cpue_sd[newdat$loc == "femeren_whitingA"] <- tmp6$se.fit[newdat$loc == "femeren_whitingA"]
...
newdat$cpue_pred.log[newdat$loc == "femeren_codA"] <- tmp1.log$fit[newdat$loc == "femeren_codA"]
newdat$cpue_pred.log[newdat$loc == "femeren_flounderA"] <- tmp2.log$fit[newdat$loc == "femeren_flounderA"]
newdat$cpue_pred.log[newdat$loc == "femeren_plaiceA"] <- tmp3.log$fit[newdat$loc == "femeren_plaiceA"]
newdat$cpue_pred.log[newdat$loc == "femeren_herringA"] <- tmp4.log$fit[newdat$loc == "femeren_herringA"]
newdat$cpue_pred.log[newdat$loc == "femeren_spratA"] <- tmp5.log$fit[newdat$loc == "femeren_spratA"]
newdat$cpue_pred.log[newdat$loc == "femeren_whitingA"] <- tmp6.log$fit[newdat$loc == "femeren_whitingA"]
newdat$cpue_sd.log <- NA
newdat$cpue_sd.log[newdat$loc == "femeren_codA"] <- tmp1.log$se.fit[newdat$loc == "femeren_codA"]
newdat$cpue_sd.log[newdat$loc == "femeren_flounderA"] <- tmp2.log$se.fit[newdat$loc == "femeren_flounderA"]
newdat$cpue_sd.log[newdat$loc == "femeren_plaiceA"] <- tmp3.log$se.fit[newdat$loc == "femeren_plaiceA"]
newdat$cpue_sd.log[newdat$loc == "femeren_herringA"] <- tmp4.log$se.fit[newdat$loc == "femeren_herringA"]
newdat$cpue_sd.log[newdat$loc == "femeren_spratA"] <- tmp5.log$se.fit[newdat$loc == "femeren_spratA"]
newdat$cpue_sd.log[newdat$loc == "femeren_whitingA"] <- tmp6.log$se.fit[newdat$loc == "femeren_whitingA"]

write_rds (newdat, "newdat/newdat_femerenA.rds")
